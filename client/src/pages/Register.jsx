...
const Register = () => {
  ...
  const inputClass =
    'w-full px-3.5 py-2.5 rounded-lg border border-gray-300 text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Join AttendanceIQ</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                placeholder="••••••••"
                className={`${inputClass} ${passwordError ? 'border-red-400 focus:ring-red-400' : ''}`}
              />
              {passwordError && (
